...
const ticketTableName: string = <string>(process.env.TICKET_TABLE_NAME);
const bucketName: string = <string>(process.env.CRYPTO_TICKET_BUCKET_NAME);
const repo: CryptoRepository = new CryptoRepository(ticketTableName, bucketName);
